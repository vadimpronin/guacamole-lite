...
class ClientConnection extends EventEmitter {
    ...
    constructor(clientOptions, connectionId, webSocket, query, callbacks) {
        ...
        try {
            ...
            this.connectionSelector = this.connectionSettings.connection.type;
    ...
    mergeConnectionOptions() {
        ...
        Object
            .keys(this.query)
            .filter(key => this.clientOptions.allowedUnencryptedConnectionSettings[this.connectionSelector].includes(key))
            .forEach((key) => {
                let realKey = key;
        ...
        DeepExtend(
            compiledSettings,
            this.clientOptions.connectionDefaultSettings[this.connectionSelector],
